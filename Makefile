...
ALPINE_IMAGES=$(PHP_VERSION)-cli-alpine $(PHP_VERSION)-fpm-alpine $(PHP_VERSION)-caddy-alpine $(PHP_VERSION)-nginx-alpine
DEBIAN_IMAGES=$(PHP_VERSION)-cli-$(DEBIAN_SUITE) $(PHP_VERSION)-fpm-$(DEBIAN_SUITE) $(PHP_VERSION)-caddy-$(DEBIAN_SUITE) $(PHP_VERSION)-nginx-$(DEBIAN_SUITE)
